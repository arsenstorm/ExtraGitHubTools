...
export function SidebarHeading({ className, children, ...props }: Readonly<React.ComponentPropsWithoutRef<'h3'>>) {
  return (
    ...
    <span className={clsx(className, 'relative')}>
      ...
      {'href' in props ? (
        <Headless.CloseButton
          // @ts-ignore - something weird that isn't actually a problem
          as={Link}
          {...props}
          className={classes}
